package com.ft.adminService.util;
...
public class PhoneUtil {
    ...
    //绑定主叫、被叫关系的接口http地址
    private String URI_SEND_BIND =
            "https://call.yunpian.com/v2/call/bind.json";

    //解绑主叫、被叫关系的接口http地址
    private String URI_SEND_UNBIND =
    ...
    public void sendPhone() {
        try {
            ...
            String apikey = "9df74067a9aa21e8cc3a67eadfba0bc9";

            //修改为您要发送的手机号
            String mobile = "18281635009";
            ...
            System.out.println(tplSendSms(apikey, tpl_id, tpl_value,
                    mobile)+"hehe");
            ...
            //System.out.println( bindCall(apikey, from ,to , duration));

            /**************** 使用接口解绑主被叫号码 *****************/
            //System.out.println( unbindCall(apikey, from, to))
        } catch (Exception e) {
